...
[![Go Report Card](https://goreportcard.com/badge/github.com/ibadi-id/go-mail)](https://goreportcard.com/report/github.com/ibadi-id/go-mail)
[![Test](https://github.com/ibadi-id/go-mail/actions/workflows/test.yml/badge.svg?branch=main)](https://github.com/ibadi-id/go-mail/actions/workflows/test.yml)
...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat)](https://pkg.go.dev/github.com/ibadi-id/go-mail)
...
```bash
go get -u github.com/ibadi-id/go-mail
```

## Docs

Documentation can be found at the [Go Docs](https://pkg.go.dev/github.com/ibadi-id/go-mail), but we have included a
